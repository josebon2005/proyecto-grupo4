...
@section('contenido')
    <div class="bg-white rounded-xl shadow-md p-6 max-w-2xl">
        <h3 class="text-2xl font-bold text-gray-700 mb-6">Crear Categoría</h3>
        ...
        <form action="{{ route('admin.categorias.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="descripcion"
                          rows="4"
                          class="w-full border rounded-lg px-4 py-2 focus:ring focus:ring-indigo-200">{{ old('descripcion') }}</textarea>
